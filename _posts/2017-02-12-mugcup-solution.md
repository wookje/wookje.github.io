...
태어나서 처음으로 열어본 대회이다. 사실 cms로 직접 짜서 열려고 했는데, 로드밸런싱 할 생각하니까 막막해서 스타트링크(!!!!!)의 도움을 받아 [acmicpc.net](acmicpc.net)에서 개최하게 되었다! 다만 대회가 조금 아쉬웠던 게, 여러 사정에 의해 출제자가 꽤 많아져서 내가 문제를 일일히 검증하기가 어려웠다. (사실 포켓몬 잡느라 귀찮아서 안 했다) 결국 두 문제에서 오류가 발견되었고 덕분에 슬랙에서 신나게 까였다. ~~(내가 낸 문제 아닌데 ㅠㅠ)~~
