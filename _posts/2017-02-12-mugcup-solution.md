...
태어나서 처음으로 열어본 대회이다. 사실 cms로 직접 짜서 열려고 했는데, 로드밸런싱 할 생각하니까 막막해서 스타트링크의 도움을 받아 [acmicpc.net](acmicpc.net)에서 개최하게 되었다! 다만 대회가 조금 아쉬웠던 게, 여러 사정에 의해 출제자가 꽤 많아져서 내가 문제를 일일히 검증하기가 어려웠다. (사실 포켓몬 잡느라 귀찮아서 안 했다)

## A. 준오는 심술쟁이!!

출제자: [behind06](https://www.acmicpc.net/user/behind06) (나)  

원래 계획에 없던 문제인데, 문제 업로드 실수로 대회가 하루 연기되는 바람에 이벤트 문제(?)로 출제하였다.
