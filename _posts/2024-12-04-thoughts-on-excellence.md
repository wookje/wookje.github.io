...
사실 치트키 수준의 조언을 듣고도 그냥 흘려버리는 재능있는 동생들이 안타까워 이 내용을 적으려고 했는데, 쓰면서 깊게 생각하다가 보니 글이 길어졌다.  
...
탁월해지기에 가장 중요한 건 양질의 생각, 높은 생각, 정교한 생각을 선별하는 능력이다. 좋은 생각을 구별할 수 있어야만 탁월해지는 방향을 구별할 수 있기 때문이다. 어떤 면에서는 이러한 선구안 자체가 잠재력이 특정 수치 이상일 때 생기는 능력일 수도 있다.  
