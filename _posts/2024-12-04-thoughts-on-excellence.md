...
요약하면 '이거 좋은 것 같으니 먹여줘' 하는 것이다. 나는 게을러서 어떤 사물을 50% 이상 담으려고 노력한 적은 없다. 정말로 전부 도중에 포기해버렸다. 하지만 1%라도, 추상적으로라도 생각을 담으면 생각의 길이 열린다. 그 길이 필요해졌을 때는 이를테면 30%만큼 전진하는 것이다. 이러한 사이클의 반복이 내가 강해지는 것에 크게 기여한 면이 있다. 신빙성을 높이는 근거로, 내 주변에서 같이 탁월해지는 사람들도 위의 능력을 대부분 가지고 있다.  
