...
문제를 내다보니 미처 고려하지 못한 조건 때문에 엄청 쉽게 풀려서 당황스러웠다.
...
그냥 시간을 출력하라고 하는 건데 스페셜 저지 만들기가 귀찮아서... 왜 그랬을까 ㅜㅜ
...
그냥 flood fill 아니고 메모리 제한 때문에 최적화도 해야하는 문제인데 ㅠㅠ

문제의 조건 때문에 주난에서 범인으로 가는 최단경로를 찾는 문제가 되어버렸다 ㅠㅠ

야심차게 all solve 방지용으로 출제했는데 너무 슬프다...
